     ...
     )
{
  ...
  if (!strcmp(param,"setvaluedmap")) {
    ...
    Cudd mgr;
    SymbolicSet set;
    set.LoadFromFile(mgr,filename,1);
    vector<vector<double>> inputs = set.setValuedMap(x,idx);
